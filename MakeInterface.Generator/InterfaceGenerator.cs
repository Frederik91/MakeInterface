...
{
    private const string InterfaceIncludeSource = """
// <auto-generated/>
#nullable enable
...
""";
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        {
            ctx.AddSource("GenerateInterfaceAttribute.g.cs", """
// <auto-generated/>
#nullable enable
namespace MakeInterface;
...
""");
            ctx.AddSource("MakeInterface.InterfaceIncludeAttribute.g.cs",
                SourceText.From(InterfaceIncludeSource, Encoding.UTF8));
        });
    ...
    private InterfaceDeclarationSyntax? GenerateInterface(string interfaceName, ClassDeclarationSyntax classSyntax, SemanticModel semanticModel)
    {
        ...
        bool anyIncludes = classSyntax.Members.Any(m =>
            ContainsAttributeWithName(m.AttributeLists, nameof(InterfaceIncludeAttribute)));
